...
@output_keywords = ("BUZZER_ON","BUZZER_OFF","MOTOR_LEFT_SPEED(integer)","MOTOR_RIGHT_SPEED(integer)",
		    ...
		    "SET_LIR_THRESHOLD(integer)","SET_RIR_THRESHOLD(integer)","SEND(integer)","TURN_LEFT","TURN_RIGHT","LEFT_BACK","RIGHT_BACK","PARK");
...
if( $length_output !=0 )
{
 for $elem (@output_signature)
 {
	...
	if ( $elem eq "TURN_LEFT" )
	{
	  print OF " $modulename\_O_TURN_LEFT(void)\n";
 	  print OF "{\n";
	  print OF "	TURN_LEFT();\n";
	  print OF "}\n";	
	}
	if ( $elem eq "TURN_RIGHT" )
	{
	  print OF " $modulename\_O_TURN_RIGHT(void)\n";
 	  print OF "{\n";
	  print OF "	TURN_RIGHT();\n";
	  print OF "}\n";	
	}
	if ( $elem eq "LEFT_BACK" )
	{
	  print OF " $modulename\_O_LEFT_BACK(void)\n";
 	  print OF "{\n";
	  print OF "	LEFT_BACK();\n";
	  print OF "}\n";	
	}
	if ( $elem eq "RIGHT_BACK" )
	{
	  print OF " $modulename\_O_RIGHT_BACK(void)\n";
 	  print OF "{\n";
	  print OF "	RIGHT_BACK();\n";
	  print OF "}\n";	
	}
	if ( $elem eq "PARK" )
	{
	  print OF " $modulename\_O_PARK(void)\n";
 	  print OF "{\n";
	  print OF "	PARK();\n";
	  print OF "}\n";	
	}
