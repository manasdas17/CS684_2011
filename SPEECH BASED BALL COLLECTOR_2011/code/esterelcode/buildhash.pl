...
@output_keywords = ("BUZZER_ON","BUZZER_OFF","MOTOR_LEFT_SPEED(integer)","MOTOR_RIGHT_SPEED(integer)",
		    ...
		    "MOVE_FWD_DIST(integer)","MOVE_INPLACE_LEFT_DEGREE(integer)","MOVE_INPLACE_RIGHT_DEGREE(integer)","MOVE_INPLACE_RIGHT_SPEED(integer)",
		    ...
		    "SET_LIR_THRESHOLD(integer)","SET_RIR_THRESHOLD(integer)","SEND(integer)","PICK","DROP");
...
if( $length_output !=0 )
{
 for $elem (@output_signature)
 {
	...
	if ( $elem eq "MOVE_INPLACE_RIGHT_SPEED(integer)" )
	{
	  print OF "$modulename\_O_MOVE_INPLACE_RIGHT_SPEED(int val)\n";
 	  print OF "{\n";
	  print OF "	rotate_inplace_right_speed(val);\n";
	  print OF "}\n";	
	}
	...
	if ( $elem eq "PICK" )
	{
	  print OF "$modulename\_O_PICK(void)\n";
 	  print OF "{\n";
	  print OF "	PICK();\n";
	  print OF "}\n";	
	}
	if ( $elem eq "DROP" )
	{
	  print OF "$modulename\_O_DROP(void)\n";
 	  print OF "{\n";
	  print OF "	DROP();\n";
	  print OF "}\n";	
	}
	if ( $elem eq "MOVE_TO_PICK" )
	{
	  print OF "$modulename\_O_MOVE_TO_PICK(void)\n";
 	  print OF "{\n";
	  print OF "	move_to_pick();\n";
	  print OF "}\n";	
	}
 }
}
