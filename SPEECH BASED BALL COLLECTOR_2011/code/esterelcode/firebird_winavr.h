...
/*
  This function is used to pick object using arm, which is made by using 3 servo motors.
*/
...
/*
  This function is used to drop object into bucket using servo motors.
*/
void DROP(void)
{
	_delay_ms(230);
...
/*
  This function sends data to zigbee module
*/
void SEND(int out_data)
{
	unsigned char temp;
	temp = (unsigned char)(out_data);
	UDR0 = temp;
}

/*
  This function receives data from zigbee module
*/
int RECEIVE(void)
{
	int in_data;
...
/*Robot rotates right at a specified speed for 500 msec.
*/

void rotate_inplace_right_speed(unsigned int speed){
	MOVE_FWD();
